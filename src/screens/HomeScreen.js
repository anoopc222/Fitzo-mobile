...
import {
  ...
  RefreshControl, ActivityIndicator, Modal, Dimensions, TextInput, Alert, Animated,
} from 'react-native';
...
const createStyles = (colors) => StyleSheet.create({
  ...
  consistCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 16, borderWidth: 1.5, borderColor: colors.border, padding: 14, marginHorizontal: 16, marginBottom: 16, gap: 14 },
