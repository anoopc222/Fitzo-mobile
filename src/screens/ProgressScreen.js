...
const createStyles = (colors) => StyleSheet.create({
  ...
  histDate: { width: 50, fontSize: 10, color: colors.textMuted },
  histSets: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', gap: 4, alignItems: 'center' },
  histSet: {
    fontSize: 10, lineHeight: 14, color: colors.text, fontWeight: weight.medium,
    backgroundColor: colors.bgElevated, paddingHorizontal: 6, paddingVertical: 3, borderRadius: 6,
  },
